...
SECRET_KEY = 'django-insecure-c3pbaw1et*u-js=l@o5a8-(p2d97$!%8v&fi!_jcom=kg*@fl#'
...
INSTALLED_APPS = [
    ...
    'users',        #created User app
    'django_extensions',  #added django extensions
    'news', #created news app
    'drf_yasg',
    'corsheaders',
]
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),                             #JWT TOKEN TIME SETUP
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    'http://localhost:8000',
    'http://localhost:5500',               #allow local host for testing
]
